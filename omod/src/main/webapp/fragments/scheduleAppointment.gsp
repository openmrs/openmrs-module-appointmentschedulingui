...
<div id="appointmentscheduling-scheduleAppointment" class="scheduleAppointment" ng-controller="ScheduleAppointmentCtrl"  ng-init='init(${ patient?.patient?.uuid ? '"' + patient.patient.uuid + '"' : null},  ${ '"' + ui.escapeJs(returnUrl) + '"' } )'>
       ...
       <div ng-show="showConfirmAppointment" id="confirmAppointment" class="container" ng-controller="ConfirmAppointmentCtrl" ng-init='init(${ canOverbook },  ${'"' + ui.escapeJs(returnUrl) + '"' } )'>
            <h2>
