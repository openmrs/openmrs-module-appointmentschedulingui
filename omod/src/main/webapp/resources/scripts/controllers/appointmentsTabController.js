    ...
    .controller('AppointmentsTabCtrl', ['$scope',
        ...
        function ($scope) {
            $scope.init = function() {
                ...
                // don't load the appointments and appointment requests until the appt tab is select (we are running into a angular error I can solve if we try to pre-load these)
